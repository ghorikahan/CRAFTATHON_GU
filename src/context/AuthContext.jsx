...
export const AuthProvider = ({ children }) => {
  ...
  // 2. INTERVAL EVALUATION (Fast 1-second ticks for live demo!)
  useEffect(() => {
    let interval;
    if (user) {
      interval = setInterval(async () => {
        ...
        let payload = {
          ...
          typing_speed: b.charCount / 1.0, // Divided by 1 due to 1-second interval
